  ...
  return (
    <footer className="w-full pt-0 sm:pt-6 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        <a href="mailto:sadiearj@gmail.com">
          <MagicButton
        ...
        <div className="flex items-center md:gap-3 gap-6 mt-6">
          {socialMedia.map((info) => (
            <a href={info.link} target="_blank" key={info.link}>
              <div
                key={info.link}
                className="w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-black-300 hover:bg-purple/80"
              >
                <Image 
                  src={info.img} 
